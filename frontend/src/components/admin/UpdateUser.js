...
import { getUserForAdmin, updateUserForAdmin } from "../../actions/userActions";
...
export default function UpdateUser() {
  ...
  const { user: adminUser } = useSelector((state) => state.authState);
  ...
  const submitHandler = (e) => {
    ...
    dispatch(updateUserForAdmin(userId, formData));
  };
